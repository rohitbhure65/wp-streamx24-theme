            ...
            <div class="sx-post-grid">
                ...
                <div class="sx-post-content-wrapper">
                    ...
                    <div class="sx-post-tags">
                        <span class="sx-tags-label">Tags:</span>
                    ...
                    <div class="sx-post-share">
                        <span class="sx-share-label">Share this post:</span>
                        <div class="sx-share-buttons">
                            <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode(get_permalink()); ?>&text=<?php echo urlencode(get_the_title()); ?>" target="_blank" class="sx-share-btn sx-share-twitter" aria-label="Share on Twitter">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                                </svg>
                            </a>
                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>" target="_blank" class="sx-share-btn sx-share-facebook" aria-label="Share on Facebook">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
                            <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode(get_permalink()); ?>&title=<?php echo urlencode(get_the_title()); ?>" target="_blank" class="sx-share-btn sx-share-linkedin" aria-label="Share on LinkedIn">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                                </svg>
                            </a>
                            <a href="mailto:?subject=<?php echo urlencode(get_the_title()); ?>&body=<?php echo urlencode(get_permalink()); ?>" class="sx-share-btn sx-share-email" aria-label="Share via Email">
                    ...
                    <div class="sx-author-box">
                        <div class="sx-author-box-inner">
                            ...
                            <div class="sx-author-box-content">
                                <h3 class="sx-author-box-title">About <?php the_author(); ?></h3>
                                <p class="sx-author-box-bio"><?php echo esc_html($author_bio ? $author_bio : 'This author has not provided a bio yet.'); ?></p>
                    ...
                    <section class="sx-related-posts">
                        <h2 class="sx-related-posts-title">Related Posts</h2>
                        <div class="sx-related-posts-grid">
                            ...
                            <article class="sx-related-post">
                                ...
                                <div class="sx-related-post-content">
                                    <span class="sx-related-post-date"><?php echo get_the_date('F j, Y'); ?></span>
                                    <h3 class="sx-related-post-title">
                                        <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                    </h3>
                                    <a href="<?php the_permalink(); ?>" class="sx-related-post-link">Read More</a>
                                </div>
                            </article>
                            <?php
                            endwhile;
                    ...
                    <section class="sx-comments-section">
                        ...
                        <div class="sx-comments-wrapper">
                            <h2 class="sx-comments-title">
                                ...
                                if ($comments_number) {
                                    printf(_n('%s Comment', '%s Comments', $comments_number, 'streamx24'), number_format_i18n($comments_number));
                                } else {
                            ...
                            <?php comment_form(
                                array(
                                    ...
                                    'comment_field' => '<textarea id="comment" name="comment" class="sx-comment-textarea" placeholder="Write your comment..." rows="5" required></textarea>',
                                    'fields' => array(
                                        'author' => '<input type="text" id="author" name="author" class="sx-comment-input" placeholder="Your Name *" required>',
                                        'email' => '<input type="email" id="email" name="email" class="sx-comment-input" placeholder="Your Email *" required>',
                                        'url' => '',
                                    ),
                                )
                            ); ?>
                ...
                <aside class="sx-sidebar">
                    ...
                    <div class="sx-widget sx-widget-search">
                        <h3 class="sx-widget-title">Search</h3>
                        <form role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>" class="sx-search-form">
                            <input type="search" name="s" placeholder="Search posts..." class="sx-search-input" required>
                            <button type="submit" class="sx-search-btn" aria-label="Search">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="sx-widget sx-widget-categories">
                        <h3 class="sx-widget-title">Categories</h3>
                    ...
                    <div class="sx-widget sx-widget-recent">
                        <h3 class="sx-widget-title">Recent Posts</h3>
                        <ul class="sx-recent-posts-list">
                            ...
                            <li class="sx-recent-post-item">
                                ...
                                <div class="sx-recent-post-info">
                                    <span class="sx-recent-post-date"><?php echo get_the_date('F j, Y', $post['ID']); ?></span>
                    ...
                    <div class="sx-widget sx-widget-newsletter">
                        <h3 class="sx-widget-title">Newsletter</h3>
                        <p class="sx-newsletter-desc">Stay updated with our latest posts and news.</p>
                        <form class="sx-newsletter-form" action="#" method="post">
                            <input type="email" name="newsletter_email" class="sx-newsletter-input" placeholder="Enter your email" required>
                            <button type="submit" class="sx-btn sx-btn-primary sx-newsletter-btn">Subscribe</button>
                        </form>
                    </div>

                    <!-- Tags Widget -->
                    <div class="sx-widget sx-widget-tags">
                        <h3 class="sx-widget-title">Popular Tags</h3>
